export const mockDonutsData = [
  ...
  },
  {
    node: {
      ...
      name: "チョコレートスティック",
      price: "0",
      description: "スティックドーナツに、チョコレートクリームを詰めました。",
  ...
  },
  {
    node: {
      ...
      name: "ストロベリースティック",
      price: "0",
      description: "スティックドーナツに、ストロベリーフィリングを詰めました。",
  ...
  },
  {
    node: {
      ...
      name: "レモンパイ",
      price: "0",
      description: "練りパイタイプの生地にレモンクリームを挟んで揚げました。",
  ...
  },
  {
    node: {
      ...
      name: "マロンパイ",
      price: "0",
      description: "練りパイタイプの生地にマロンクリームを挟んで揚げました。",
  ...
  },
  {
    node: {
      ...
      name: "シナモン",
      price: "40",
      description: "ベーシックなケーキタイプの生地に、シナモンをまぶしました。",
